...
% Provenance markers: every value, figure and question block injected from
% the project is colored and linked to its source. Drop the option for the
% journal version.
\usepackage[provenance]{calkit}
\ckbaseurl{https://github.com/petebachant/boundary-layer-turbulence-modeling/blob/main/}
...
\begin{figure}
  ...
  \caption{Left: dissipation coefficient, with the equilibrium band of this
    ...
    peaking at transition onset.\ckcaptionsource{../figures/dissipation.pdf}}
...
\begin{figure}
  ...
  \caption{The same library fits either target in sample and fails out of it.\ckcaptionsource{../figures/transfer.pdf}}
  \label{fig:transfer}
\end{figure}
...
\begin{figure}
  ...
  \caption{Collapse error for each candidate against the streamwise coordinate
    ...
    best-correlated variable is not the best-collapsing one.\ckcaptionsource{../figures/collapse.pdf}}
  \label{fig:collapse}
\end{figure}
...
\begin{figure}
  ...
  \caption{Each marker is one seed; bars span one standard deviation.\ckcaptionsource{../figures/fit-noise.pdf}}
  \label{fig:noise}
\end{figure}
...
\begin{figure}
  ...
  \caption{Skin friction against the DNS (markers) on the matched domain.\ckcaptionsource{../figures/model-comparison.pdf}}
  \label{fig:benchmark}
\end{figure}
