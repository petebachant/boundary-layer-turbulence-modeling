...
void ransFromDns<BasicTurbulenceModel>::correctNut()
{
...
template<class BasicTurbulenceModel>
tmp<fvScalarMatrix> ransFromDns<BasicTurbulenceModel>::kSource() const
{
...
template<class BasicTurbulenceModel>
tmp<fvScalarMatrix> ransFromDns<BasicTurbulenceModel>::epsilonSource() const
{
    return tmp<fvScalarMatrix>::New
    (
        epsilon_,
...
template<class BasicTurbulenceModel>
ransFromDns<BasicTurbulenceModel>::ransFromDns
(
...
template<class BasicTurbulenceModel>
bool ransFromDns<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
void ransFromDns<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
